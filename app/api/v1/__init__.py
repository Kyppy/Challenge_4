...
from .users.users_views import Signup, Login, UserData, SessionAuth, \
                               UserPrivilege
...
api.add_resource(SessionAuth, '/session/<username>')
api.add_resource(UserPrivilege, '/priv/<username>')
